namespace TP2.Externalization
{
    public class UiText
    {
        public const string ALERT_ERROR = "Une erreur est survenue, veillez essayer plus tard";
        public const string ALERT_ERROR_LOGIN = "Le nom utilisateur ou le mot de passe est incorrect";
